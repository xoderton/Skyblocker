            ...
            try (ApiResponse response = Http.sendHypixelRequest("skyblock/museum", "?profile=" + profileId)) {
                ...
                if (response.ok()) {
                    ...
                    if (members.has(uuid)) {
                        ...
                        if (source != null)
                            source.sendFeedback(Constants.PREFIX.get().append(Text.translatable("skyblocker.museum.resyncSuccess")));
                        ...
                        if (source != null)
                            source.sendFeedback(Constants.PREFIX.get().append(Text.translatable("skyblocker.museum.resyncFailure")));
