...
public class EggFinder {
    ...
    public static void init() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (!SkyblockerConfigManager.get().helpers.chocolateFactory.enableEggFinder || client.player == null)
                return;
    ...
    public enum EggType {
        ...
        public void setSeen() {
            egg.seen = true;
            if (!SkyblockerConfigManager.get().helpers.chocolateFactory.sendEggFoundMessages || System.currentTimeMillis() - messageLastSent < 1000)
                return;
            if (collected) {
